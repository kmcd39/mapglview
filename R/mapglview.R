...
#' mapglview
#'
#' TODO -- when i pipe in from a a longer expression, it doesn't work b/c the
#' name being used for layer splits (or b/c it may include escape characters)
#'
#' Also, the legend doesn't seem to reliably match the values for categorical
#' vars. Categorical palettes also can't handle NAs rn. and also shows just grey
#' w factors...
#'
